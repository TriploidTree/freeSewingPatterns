...
var withStorage = function withStorage(WrappedComponent, name) {
  return /*#__PURE__*/function (_React$Component) {
    ...
    function _class(props) {
      ...
      _this.setStorageData = _this.setStorageData.bind(_assertThisInitialized(_this));
      _this.updateStorageData = _this.updateStorageData.bind(_assertThisInitialized(_this));
      _this.state = {
        data: storage__default['default'].get(name) || {}
      };
      return _this;
    }
    ...
    _createClass(_class, [{
      key: "setStorageData",
      value: function setStorageData(data) {
        storage__default['default'].set(name, data);
      }
    }, {
      key: "updateStorageData",
      value: function updateStorageData(value) {
        ...
        if (l3) data[l1][l2][l3] = value;else if (l2) data[l1][l2] = value;else data[l1] = value;
        this.setState({
          data: data
        });
        storage__default['default'].set(name, data);
