...
for (var i = 0.1; i < 1; i += 0.1) {
  var name$2 = "Doll ".concat(Math.round(i * 10), "/10");
  nonHuman.withBreasts.dolls[name$2] = {}; // withBreasts: Based on Anneke (size 34)
  ...
  for (var _i = 0, _Object$entries = Object.entries(models.withBreasts.size34); _i < _Object$entries.length; _i++) {
    ...
    nonHuman.withBreasts.dolls[name$2][m] = m === 'shoulderSlope' ? val : round(val * i);
  } // withoutBreasts: Based on Ronan (size 42)


  nonHuman.withoutBreasts.dolls[name$2] = {};
  ...
  for (var _i2 = 0, _Object$entries2 = Object.entries(models.withoutBreasts.size42); _i2 < _Object$entries2.length; _i2++) {
    ...
    nonHuman.withoutBreasts.dolls[name$2][_m] = _m === 'shoulderSlope' ? _val : round(_val * i);
  }
}
...
var Measurements = function Measurements(props) {
  ...
  })), /*#__PURE__*/React__default['default'].createElement("h5", null, "Humans"), /*#__PURE__*/React__default['default'].createElement("ul", {
    style: styles.ul
  ...
  })), /*#__PURE__*/React__default['default'].createElement("h5", null, "Dolls"), /*#__PURE__*/React__default['default'].createElement("ul", {
    style: styles.ul
  }, Object.keys(nonHuman.withoutBreasts.dolls).map(function (m) {
    return /*#__PURE__*/React__default['default'].createElement("li", {
      key: "".concat(m, "-without"),
      style: styles.li
    }, /*#__PURE__*/React__default['default'].createElement(Button__default['default'], {
      onClick: function onClick() {
        return props.preloadMeasurements(nonHuman.withoutBreasts.dolls[m]);
      }
    }, /*#__PURE__*/React__default['default'].createElement(Icon, {
      icon: "withoutBreasts"
    }), /*#__PURE__*/React__default['default'].createElement(reactIntl.FormattedMessage, {
  ...
  }), Object.keys(nonHuman.withBreasts.dolls).map(function (m) {
    return /*#__PURE__*/React__default['default'].createElement("li", {
      key: "".concat(m, "-with"),
      style: styles.li
    }, /*#__PURE__*/React__default['default'].createElement(Button__default['default'], {
      onClick: function onClick() {
        return props.preloadMeasurements(nonHuman.withBreasts.dolls[m]);
      }
    }, /*#__PURE__*/React__default['default'].createElement(Icon, {
      icon: "withBreasts"
    }), /*#__PURE__*/React__default['default'].createElement(reactIntl.FormattedMessage, {
  ...
  })), /*#__PURE__*/React__default['default'].createElement("h5", null, "Giants"), /*#__PURE__*/React__default['default'].createElement("ul", {
    style: styles.ul
  }, Object.keys(nonHuman.withoutBreasts.giants).map(function (m) {
    return /*#__PURE__*/React__default['default'].createElement("li", {
      key: "".concat(m, "-without"),
      style: styles.li
    }, /*#__PURE__*/React__default['default'].createElement(Button__default['default'], {
      onClick: function onClick() {
        return props.preloadMeasurements(nonHuman.withoutBreasts.giants[m]);
      }
    }, /*#__PURE__*/React__default['default'].createElement(Icon, {
      icon: "withoutBreasts"
    }), /*#__PURE__*/React__default['default'].createElement(reactIntl.FormattedMessage, {
  ...
  }), Object.keys(nonHuman.withBreasts.giants).map(function (m) {
    return /*#__PURE__*/React__default['default'].createElement("li", {
      key: "".concat(m, "-with"),
      style: styles.li
    }, /*#__PURE__*/React__default['default'].createElement(Button__default['default'], {
      onClick: function onClick() {
        return props.preloadMeasurements(nonHuman.withBreasts.giants[m]);
      }
    }, /*#__PURE__*/React__default['default'].createElement(Icon, {
      icon: "withBreasts"
    }), /*#__PURE__*/React__default['default'].createElement(reactIntl.FormattedMessage, {
...
/**
 * @freesewing/plugin-svgattr | v2.19.5
...
/**
 * @freesewing/plugin-i18n | v2.19.5
